...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference("Gym.count") do
      post gyms_url, params: { gym: { address: @gym.address, closes: @gym.closes, name: @gym.name, opens: @gym.opens } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { address: @gym.address, closes: @gym.closes, name: @gym.name, opens: @gym.opens } }
